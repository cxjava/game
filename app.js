...
const goappEnv = {"GOAPP_INTERNAL_URLS":"null","GOAPP_ROOT_PREFIX":"/game","GOAPP_STATIC_RESOURCES_URL":"/game","GOAPP_VERSION":"59d590d064584610f95c4835d5edf01e4b349ca8"};
const goappLoadingLabel = "加载中，请稍后⏳⌛️";
...
function goappSetupAutoUpdate(registration) {
  const autoUpdateInterval = "600000";
...
async function goappInitWebAssembly() {
  ...
  try {
    ...
    const wasm = await instantiateStreaming(
      fetchWithProgress("/game/web/app.wasm", showProgress),
      go.importObject
    );
